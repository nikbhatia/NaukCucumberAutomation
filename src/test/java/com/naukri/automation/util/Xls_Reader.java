...
public class Xls_Reader {
	public static String filename = System.getProperty("user.dir") + "\\TestData.xls";
	public String path;
	...
	public boolean setCellData(String sheetName, int colNum, int rowNum, String data) {
		try {
			...
			if (data.toLowerCase().startsWith("pass"))
				...
				setOrangeColour(sheetName, colNum, rowNum);
			else
				setWhiteColour(sheetName, colNum, rowNum);
...
//cell.setCellStyle(cs);
			...
			if (data.toLowerCase().startsWith("pass"))
				...
				setOrangeColour(sheetName, colName, rowNum);
...
//System.out.println("**caught "+(i+index));
	...
	public boolean setOrangeColour(String sheetName, String colName, int rowNum) {
		try {
			fis = new FileInputStream(path);
			workbook = new HSSFWorkbook(fis);
...
//code ends
	...
	public boolean setOrangeColour(String sheetName, int colNum, int rowNum) {
		try {
			fis = new FileInputStream(path);
			workbook = new HSSFWorkbook(fis);
...
////////////////////////////////////////////////TARUN////////////////////////////////////////////
	...
	public boolean setCellFormula(String sheetName, String colName, int rowNum, String data) {
		try {
			fis = new FileInputStream(path);
			workbook = new HSSFWorkbook(fis);
...
//cell.setCellStyle(cs);
	...
	private boolean setWhiteColour(String sheetName, int colNum, int rowNum) {
		try {
			fis = new FileInputStream(path);
			workbook = new HSSFWorkbook(fis);
...
//code ends
	...
	private boolean setWhiteColour(String sheetName, String colName, int rowNum) {
		try {
			fis = new FileInputStream(path);
			workbook = new HSSFWorkbook(fis);
...
//code ends
	...
	public String getCellFormula(String sheetName, String colName, int rowNum) {
		try {
			if (rowNum <= 0)
				return "";
...
//////////////////////////////////////////////////               ANKIT            //////////////////////////////////
	...
	public String CreateNewFile(String template, String newFile) {
		String result = "";
		POIFSFileSystem fs;
		try {
...
//returns true if data is set successfully else false
	public boolean setCellData(String sheetName, int colNum, int rowNum, int data) {
		try {
			fis = new FileInputStream(path);
			workbook = new HSSFWorkbook(fis);
...
//System.out.println(row.getCell(i).getStringCellValue().trim());
			...
			if (cell == null)
				return "";
//System.out.println(sheetName+ " Cell type "+ cell.getCellType());
			if (cell.getCellType() == Cell.CELL_TYPE_STRING)
				return cell.getStringCellValue();
...
////////////String cellText = String.valueOf(cell.getNumericCellValue());
				String cellText = String.valueOf((float) cell.getNumericCellValue());
				if (HSSFDateUtil.isCellDateFormatted(cell)) {
//format in form of M/D/YY
					double d = cell.getNumericCellValue();
